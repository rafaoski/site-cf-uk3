...
urls()->set('uikit_css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.1.7/css/uikit.min.css');
urls()->set('uikit_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.1.7/js/uikit.min.js');
urls()->set('uikit_icons', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/3.1.7/js/uikit-icons.min.js');
