...
function ukBreadcrumb($items = null, $options = array()) {
	...
	$out = "<ul id='$options[id]' class='$class uk-text-small'>";
	...
	if($options['appendCurrent']) {
		$page = $items->wire('page');
		$out .= "<li class='uk-text-light'>$page->title</li>";
	}
...
function ukComments(CommentArray $comments, $options = array()) {
	...
	$out = "<ul id='$options[id]' class='uk-comment-list' style='list-style: none'>";
